...
from raman_config import PLOT_WAVENUMBER_RANGES
...
def export_stage6_outputs(
    ...
    # Local import avoids a circular import (raman_plotting imports pure helpers from this module).
    from raman_plotting import _save_cut_pixel_map_slice, _save_despiked_baseline_anchor_stack
